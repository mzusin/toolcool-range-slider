export declare enum CSSVariables {
    AnimateOnClick = "--tc-range-slider-animate-onclick",
    SliderWidth = "--tc-range-slider-width",
    SliderHeight = "--tc-range-slider-height",
    SliderRadius = "--tc-range-slider-panel-bg-border-radius",
    SliderBg = "--tc-range-slider-panel-bg",
    SliderBgHover = "--tc-range-slider-panel-bg-hover",
    SliderBgFill = "--tc-range-slider-panel-bg-fill",
