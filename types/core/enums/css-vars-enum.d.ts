...
export declare const SliderWidth = "--width";
export declare const SliderHeight = "--height";
export declare const SliderRadius = "--panel-bg-border-radius";
export declare const SliderBg = "--panel-bg";
export declare const SliderBgHover = "--panel-bg-hover";
export declare const SliderBgFill = "--panel-bg-fill";
export declare const PointerWidth = "--pointer-width";
export declare const PointerHeight = "--pointer-height";
export declare const PointerRadius = "--pointer-border-radius";
