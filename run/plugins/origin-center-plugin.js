...
const settings = {
  entryPoints: ['./src/plugins/origin-center-plugin/index.ts'],
  bundle: true,
  sourcemap: 'external',
  minify: true,
  target: ['es6'],
  outfile: './dist/plugins/tcrs-origin-center.min.js',
  banner: {
    js: `/* 
Tool Cool Range Slider - Origin Center Plugin v${ VERSION }
